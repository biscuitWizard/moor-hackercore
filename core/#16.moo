object #16
  ...
  property "registrar" (owner: #36, flags: "rc") = #2;

  property "prune_progress" (owner: #36, flags: "rc") = "aaa";

  property "prune_stop" (owner: #36, flags: "rc") = "zzz";

  property "total_pruned_people" (owner: #36, flags: "rc") = 0;

  property "total_pruned_characters" (owner: #36, flags: "rc") = 0;

  property "prune_task" (owner: #36, flags: "rc") = 0;

  property "alphabet" (owner: #36, flags: "rc") = "abcdefghijklmnopqrstuvwxy0123456789_.@+z";

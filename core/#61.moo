object #61
  ...
  override "moderator_notify" = {};

  override "last_msg_date" = 1721212110;

  override "moderated" = 1;

  override "moderator_forward" = "%n (%#) can't send to moderated list %t (%[#t]) directly.";
  ...
  verb "set_current_news" (this none this) owner: #36 flags: "rxd"
    if (!this:ok_write(caller, caller_perms()))
      return E_PERM;
    else
  ...
  verb "add_current_news" (this none this) owner: #36 flags: "rxd"
    if (!this:ok_write(caller, caller_perms()))
      return E_PERM;
    else
  ...
  verb "rm_current_news" (this none this) owner: #36 flags: "rxd"
    if (!this:ok_write(caller, caller_perms()))
      return E_PERM;
    else
  ...
  verb "to_text" (this none this) owner: #36 flags: "rxd"
  ...
  verb "_parse" (this none this) owner: #36 flags: "rxd"
    if (!(strings = args[1]))

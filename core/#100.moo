object #100
  ...
  override "aliases" = {"ANSI PC", "apc"};

  override "description" = "A player with the ability to see things in [red]c[bold][yellow]o[green]l[blue]o[purple]r[normal].";

  override "help" = #101;

  override "home" = #62;

  property "ansi_options" (owner: #98, flags: "r") = {};

  property "ansi_title" (owner: #98, flags: "r") = {};

  property "replace_codes" (owner: #98, flags: "r") = {};

  verb "ansi_option" (this none this) owner: #98 flags: "rxd"
  ...
  verb "@ansi-o*ptions" (any any any) owner: #98 flags: "rd"
  ...
  verb "set_ansi_option" (this none this) owner: #98 flags: "rxd"
  ...
  verb "linesplit" (this none this) owner: #98 flags: "rxd"
  ...
  verb "@ansi-t*est" (none none none) owner: #98 flags: "rd"
    "Usage:  @ansi-test";
  ...
  verb "set_name" (this none this) owner: #98 flags: "rxd"
  ...
  verb "say" (any any any) owner: #98 flags: "rx"
  ...
  verb "@who who" (any any any) owner: #98 flags: "rx"
  ...
  verb "at_item" (this none this) owner: #98 flags: "rxd"
  ...
  verb "set_aliases" (this none this) owner: #98 flags: "rxd"
  ...
  verb "title" (this none this) owner: #98 flags: "rx"
    return valid(au = $ansi_utils) ? au:ansi_title(this, pass(@args)) | pass(@args);
  endverb

  verb "confunc" (this none this) owner: #98 flags: "rxd"
  ...
  verb "@ansi-s*tatus" (any any any) owner: #98 flags: "rd"
    "Usage:";
  ...
  verb "@ansi-title" (any any any) owner: #98 flags: "rd"
    "Usage:";
  ...
  verb "set_ansi_title" (this none this) owner: #98 flags: "rxd"
  ...
  verb "emote" (any any any) owner: #98 flags: "rx"
    if ($object_utils:has_callable_verb(player.location, "say") != {#3})
      "Idiot-proofed it against porting wizards who change $room to something other than #3 (since :say would not be defined on $room.) Clueful wizards can change this.";
      return player.location:(verb)(@args);
    endif

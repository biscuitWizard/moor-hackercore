object #25
  ...
  override "description" = {"This object holds a db of places from which players have connected (see `help $site_db').", "The site blacklist and the graylist live as well (see `help blacklist')."};

  override "node_perms" = "";

  override " " = {"", "1", {}, {}};

  property "domain" (owner: #36, flags: "r") = "localdomain";

  property "prune_progress" (owner: #36, flags: "c") = "aaa";

  property "prune_stop" (owner: #36, flags: "rc") = "zzz";

  property "total_pruned_people" (owner: #36, flags: "rc") = 0;

  property "total_pruned_sites" (owner: #36, flags: "rc") = 0;

  property "prune_task" (owner: #36, flags: "rc") = 298000796;

  property "alphabet" (owner: #36, flags: "rc") = "abcdefghijklmnopqrstuvwxy0123456789_z";

  property " 1" (owner: #36, flags: "") = {"92.168.1.1", "", {"192.168.1.187", "192.168.1.102"}, {{#2}, {#2}}};

  verb "find* _only* _every*" (this none this) owner: #36 flags: "rxd"
    return caller == this || caller_perms().wizard ? pass(@args) | E_PERM;
  endverb

  verb "add" (this none this) owner: #36 flags: "rxd"
    ":add(player,site)";
  ...
  verb "domain_literal" (this none this) owner: #36 flags: "rxd"

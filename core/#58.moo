object #58
  ...
  verb "@add-option" (any at any) owner: #2 flags: "rd"
  ...
  verb "@ref*erence" (any any any) owner: #2 flags: "rd"
    if (player != this)
      return E_PERM;
    endif
    set_task_perms(player);
  ...
  verb "@toaststunt-commits @server-commits" (none none none) owner: #2 flags: "rd"

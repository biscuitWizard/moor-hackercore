object #39
  ...
  override "description" = {"A database containing all player names and aliases.  ", "See `help $player_db' for more information."};

  override " " = {"", "Hen", {"Core", "Wizard"}, {#98, #2}};

  property "stupid_names" (owner: #36, flags: "rc") = {"with", "using", "at", "to", "in", "into", "on", "onto", "upon", "out", "from", "inside", "over", "through", "under", "underneath", "beneath", "behind", "beside", "for", "about", "is", "as", "off", "of", "me", "you", "here"};

  property "frozen" (owner: #36, flags: "rc") = 0;

  property "reserved" (owner: #36, flags: "r") = {};

  property " H" (owner: #36, flags: "r") = {"", "", {"Hacker", "Housekeeper"}, {#36, #71}};

  property " e" (owner: #36, flags: "r") = {"", "v", {"Editor_Owner"}, {#96}};

  property " n" (owner: #36, flags: "r") = {"o", "", {"noone", "no_one"}, {#38, #38}};

  property " Ev" (owner: #36, flags: "r") = {"ery", "", {"everyone", "Everyman"}, {#38, #38}};

  verb "load" (this none this) owner: #36 flags: "rxd"
  ...
  verb "check" (this none none) owner: #36 flags: "rxd"
  ...
  verb "available" (this none this) owner: #36 flags: "rxd"
  ...
  verb "insert" (this none this) owner: #2 flags: "rxd"

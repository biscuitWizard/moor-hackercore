object #37
  ...
  property "node_perms" (owner: #36, flags: "rc") = "r";

  property "data" (owner: #36, flags: "r") = 4;

  property " " (owner: #36, flags: "") = {"", "", {}, {}};

  verb "find find_key" (this none this) owner: #36 flags: "rxd"
  ...
  verb "find_exact" (this none this) owner: #36 flags: "rxd"
    {search, ?sofar = 0} = args;
    rest = search;
    prefix = search[1..sofar];
    rest[1..sofar] = "";
  ...
  verb "find_all find_all_keys" (this none this) owner: #36 flags: "rxd"
    ":find_all(string [,n=0])";
    "assumes n <= length(string)";
    {search, ?sofar = 0} = args;
    rest = search;
  ...
  verb "_only" (this none this) owner: #36 flags: "rxd"
  ...
  verb "_every" (this none this) owner: #36 flags: "rxd"
    if (caller != this)
      raise(E_PERM);
    endif
    info = this.(" " + args[1]);
  ...
  verb "_every_key" (this none this) owner: #36 flags: "rxd"
    if (caller != this)
      raise(E_PERM);
    endif
    info = this.(" " + args[1]);
  ...
  verb "insert" (this none this) owner: #36 flags: "rxd"
  ...
  verb "delete2" (this none this) owner: #36 flags: "rxd"
  ...
  verb "set_node" (this none this) owner: #36 flags: "rxd"
  ...
  verb "clearall_big" (this none this) owner: #36 flags: "rxd"
    if (!($perm_utils:controls(caller_perms(), this) || caller == this))
      return E_PERM;
    endif
  ...
  verb "_kill_subtrees" (this none this) owner: #36 flags: "rxd"
  ...
  verb "depth" (this none this) owner: #36 flags: "rxd"
    info = this.(" " + (prefix = (args || {""})[1]));
    depth = 0;
    string = prefix;
    if (ticks_left() < 500 || seconds_left() < 2)
  ...
  verb "count_entries" (this none this) owner: #36 flags: "rxd"
    info = this.(" " + (prefix = args[1]));
  ...
  verb "count_chars" (this none this) owner: #36 flags: "rxd"
    info = this.(" " + (prefix = args[1]));
    count = args[2];
    for s in (info[3])
  ...
  verb "count" (any in this) owner: #36 flags: "rd"

...
async fn test_delete_non_existent_object() {
    ...
    let response = client
        .object_delete("non_existent_object")
        .await
...
async fn test_delete_object_in_added_objects() {
    ...
    println!(
        "Test: Deleting an object in added_objects should remove it from added, not add to deleted"
    );

    // Step 1: Create an object (will be in added_objects)
    println!("\nStep 1: Creating object...");
    client
        .object_update_from_file("test_delete_added", "test_object.moo")
        .await
    ...
    client
        .object_delete("test_delete_added")
        .await
    ...
    assert_eq!(
        change_after.added_objects.len(),
        0,
        "Should have 0 added objects"
    );
    assert_eq!(
        change_after.deleted_objects.len(),
        0,
        "Should have 0 deleted objects (not added to deleted since it was just added)"
    );
...
async fn test_delete_object_in_modified_objects() {
    ...
    println!(
        "Test: Deleting an object in modified_objects should remove it from modified and add to deleted"
    );
    ...
    client
        .object_update_from_file("test_delete_modified", "test_object.moo")
        .await
        .expect("Failed to create object");
    ...
    client
        .object_update_from_file("test_delete_modified", "detailed_test_object.moo")
        .await
    ...
    client
        .object_delete("test_delete_modified")
        .await
        .expect("Failed to delete object")
        .assert_success("Delete object");
    println!("✅ Delete successful");
    ...
    assert_eq!(
        change_after.modified_objects.len(),
        0,
        "Should have 0 modified objects"
    );
    assert_eq!(
        change_after.deleted_objects.len(),
        1,
        "Should have 1 deleted object"
    );
    assert_eq!(
        change_after.deleted_objects[0].name, "test_delete_modified",
        "Deleted object name should match"
    );
...
async fn test_delete_then_update_fails() {
    ...
    client
        .object_update_from_file("test_delete_update", "test_object.moo")
        .await
        .expect("Failed to create object");
    ...
    println!("\nStep 2: Deleting object...");
    client
        .object_delete("test_delete_update")
        .await
        .expect("Failed to delete object")
        .assert_success("Delete object");
    ...
    assert_eq!(
        change_after_delete.deleted_objects.len(),
        1,
        "Should have 1 deleted object"
    );
    ...
    client
        .object_update_from_file("test_delete_update", "detailed_test_object.moo")
        .await
    ...
    let in_deleted = change_after_update
        .deleted_objects
        .iter()
        .any(|obj| obj.name == "test_delete_update");
    let in_modified = change_after_update
        .modified_objects
        .iter()
        .any(|obj| obj.name == "test_delete_update");
...
async fn test_delete_renamed_object_old_name_fails() {
    ...
    client
        .object_update_from_file("old_name", "test_object.moo")
        .await
        .expect("Failed to create object");
...
async fn test_delete_renamed_object_new_name_succeeds() {
    ...
    client
        .object_update_from_file("old_name_del", "test_object.moo")
        .await
        .expect("Failed to create object");
    ...
    println!("\nStep 2: Renaming object...");
    client
        .object_rename("old_name_del", "new_name_del")
        .await
        .expect("Failed to rename object")
        .assert_success("Rename object");
    ...
    let change_after_delete = server
        .database()
        .index()
        .get_change(&change_id)
        .expect("Failed to get change")
    ...
    assert_eq!(
        change_after_delete.renamed_objects.len(),
        0,
        "Should have 0 renamed objects"
    );
    assert_eq!(
        change_after_delete.deleted_objects.len(),
        1,
    ...
    assert_eq!(
        change_after_delete.deleted_objects[0].name, "old_name_del",
        "Deleted object should use original name"
    );
...
async fn test_delete_with_no_active_change() {
    ...
    client
        .object_update_from_file("test_auto_change", "test_object.moo")
        .await
        .expect("Failed to create object");
    ...
    client
        .object_delete("test_auto_change")
        .await
        .expect("Failed to delete object")
        .assert_success("Delete object");
    println!("✅ Delete successful");
    ...
    assert_eq!(
        change.deleted_objects[0].name, "test_auto_change",
        "Deleted object name should match"
    );
...
async fn test_delete_already_deleted_is_idempotent() {
    ...
    client
        .object_update_from_file("test_idempotent_delete", "test_object.moo")
        .await
        .expect("Failed to create object");
    ...
    println!("\nStep 2: Deleting object...");
    client
        .object_delete("test_idempotent_delete")
        .await
        .expect("Failed to delete object")
        .assert_success("Delete object");
    ...
    assert_eq!(
        change_after_first_delete.deleted_objects.len(),
        1,
        "Should have 1 deleted object"
    );
    ...
    let change_after_second_delete = server
        .database()
        .index()
        .get_change(&change_id)
        .expect("Failed to get change")
    ...
    assert_eq!(
        change_after_second_delete.deleted_objects.len(),
        1,
        "Should still have 1 deleted object"
    );
...
async fn test_delete_object_with_meta() {
    ...
    client
        .object_update_from_file("test_with_meta", "test_object.moo")
        .await
        .expect("Failed to create object");
    ...
    println!("\nStep 2: Adding meta...");
    client
        .meta_add_ignored_property("test_with_meta", "test_prop")
        .await
        .expect("Failed to add ignored property")
        .assert_success("Add ignored property");

    // Verify meta exists
    let meta_exists = server
        .database()
        .refs()
        .get_ref(VcsObjectType::MooMetaObject, "test_with_meta", None)
    ...
    let deleted_object_count = change_after_delete
        .deleted_objects
        .iter()
        .filter(|obj| obj.object_type == VcsObjectType::MooObject && obj.name == "test_with_meta")
        .count();
    let deleted_meta_count = change_after_delete
        .deleted_objects
        .iter()
        .filter(|obj| {
            obj.object_type == VcsObjectType::MooMetaObject && obj.name == "test_with_meta"
        })
        .count();
...
async fn test_delete_then_rename_fails() {
    ...
    client
        .object_update_from_file("test_delete_rename", "test_object.moo")
        .await
        .expect("Failed to create object");
    ...
    println!("\nStep 2: Deleting object...");
    client
        .object_delete("test_delete_rename")
        .await
        .expect("Failed to delete object")
        .assert_success("Delete object");
    println!("✅ Object deleted");
    ...
    let response = client
        .object_rename("test_delete_rename", "renamed_deleted")
        .await
        .expect("Request should complete");

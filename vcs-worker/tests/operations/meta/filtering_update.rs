...
async fn test_object_update_filters_ignored_properties() {
    ...
    // Create an object
    client
        .object_update_from_file("test_object_with_meta", "test_object_with_meta.moo")
        .await
        .expect("Failed to update object");

    // Add test_property to ignored properties
    client
        .meta_add_ignored_property("test_object_with_meta", "test_property")
        .await
    ...
    let get_response = client
        .object_get("test_object_with_meta")
        .await
...
async fn test_object_update_filters_ignored_verbs() {
    ...
    client
        .meta_add_ignored_verb("test_object_with_meta", "test_verb")
        .await
...
async fn test_object_update_preserves_non_ignored_items() {
    ...
    assert!(content.contains("object #"), "Object should still be valid");
    assert!(

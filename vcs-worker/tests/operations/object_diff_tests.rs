    ...
    client
        .object_update(
            ...
            vec![
                "obj #123",
                "parent #1",
                "verb \"verb1\" this none this",
                "  return 1;",
                "endverb",
                "verb \"verb2\" this none this",
                "  return 2;",
                "endverb",
            ],
        )
    ...
    client
        .object_update(
            ...
            vec![
                "obj #123",
                "parent #1",
                "verb \"keep\" this none this",
                "  return 1;",
                "endverb",
                "verb \"delete\" this none this",
                "  return 2;",
                "endverb",
            ],
        )
...
async fn test_object_diff_object_not_in_change() {
    ...
    // Should fail
    assert!(result.is_err(), "Should fail when object not in change");
    println!("✅ Correctly failed for missing object");
...
async fn test_object_diff_nonexistent_change() {
    ...
    assert!(
        result.is_err(),
        "Should fail when change ID doesn't exist"
    );
    println!("✅ Correctly failed for nonexistent change");
